...
class ectools_mdl_regions extends dbeav_model{
    ...
    public function getDlAreaById($aRegionId)
    {
        ...
        $sql = 'select c.region_id,c.p_1, c.local_name,c.p_region_id,c.ordernum,p.local_name as parent_name from '.$this->table_name(1).' as c LEFT JOIN '.$this->table_name(1).' as p ON p.region_id=c.p_region_id where c.region_id='.intval($aRegionId);
