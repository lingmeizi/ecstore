...
class b2c_user_object{
    ...
    public function get_member_info( ) {
        $memberFilter = array(
            ...
            'members'=>'member_id,member_lv_id,name,sex,experience,cur,advance,point,isjxs,up_member_id',
        );
        ...
        if( !empty($member_sdf) ) {
            ...
            $this->member_info['isjxs'] =  $member_sdf['isjxs'] == 1 ?'是':'否';
            $this->member_info['up_member_id'] =  $member_sdf['up_member_id'];
