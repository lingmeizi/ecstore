...
class b2c_ctl_site_passport extends b2c_frontpage{
    ...
    //注册页面
    public function signup($memberid,$url=null){
   ...
   /**
    ...
    public function create(){
        ...
        //$this->splash('failed',null,var_dump($_POST),$ajax_request);
        ...
        if(isset($_SESSION['upmemberid'])&&$_SESSION['upmemberid'])
        {
            $saveData["b2c_members"]["up_member_id"]=$_SESSION['upmemberid'];
        }
        unset($_SESSION['upmemberid']);
       // $this->splash('failed',null,var_dump($saveData),$ajax_request);
