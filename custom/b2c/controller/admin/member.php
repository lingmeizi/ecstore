...
class b2c_ctl_admin_member extends desktop_controller{
   ...
   function index(){
     ...
     if($_GET["up_member_id"])
        {
            //我的客户过滤，然后添加返回按钮
           $actions_base['base_filter'] = array("up_member_id"=>$_GET["up_member_id"]); 
           $custom_actions[] =  array('label'=>app::get('b2c')->_('返回'),'href'=>'index.php?app=b2c&ctl=admin_member_drp&act=index');
        }
