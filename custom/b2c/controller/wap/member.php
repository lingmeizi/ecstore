...
// echo "<pre>";print_r($this->pagedata['order']);exit;
    ...
    */
    ...
    //add by ldward 20170111 我的分享
    function myshare()
    {
        $memberModel = $this->app->model('members');
        $memberData = $memberModel->getList('isjxs', array('member_id' => $this->app->member_id, 'isjxs'=>'1'),0,1);
        if($memberData[0]['isjxs']=='1')
        {
            $res_url = $this->gen_url(array('app'=>'wap', 'ctl'=>'default', 'act'=>'index','arg0'=>$this->app->member_id,'full'=>1));
        }else{

            $res_url = $this->gen_url(array('app'=>'wap', 'ctl'=>'default', 'act'=>'index','full'=>1));
        }
       $this->pagedata['res_url']= $res_url;
       //重新微信转发朋友圈功能
        ...
        $this->pagedata['weixin']['linelink']=$res_url;
        ...
        $this->page('wap/member/myshare.html');
    }
    ...
    function custom($nPage=1){
        ...
        $this->pagedata['res_url'] = $this->app->res_url;
        $this->page('wap/member/custom.html');
    }
    ...
    function my_profit($nPage=1){
        ...
        $this->page('wap/member/my_profit.html');
    }
      /*
     *  提现明细
     * $change_type  参数用于判断是佣金明细还是提现管理
    ...
    function my_back($nPage=1){
        ...
        $this->page('wap/member/my_back.html');
    }
    //提现申请
    function profit(){
         //获取销售总额以及佣金总额
        ...
        $this->page('wap/member/profit.html');
    }
    //提现申请
    function account_apply(){
        ...
        $account_log = array(
         ...
         //刷新本页
         $url=array('app'=>'wap', 'ctl'=>'wap_member', 'act'=>'my_back');
    ...
    function addsupplier(){
        ...
        $this->page('wap/member/addsupplier.html');
    }
    ...
    function appsupplier()
    {
        ...
        if($member_drp)
        {
            $this->splash('failed',null,'分销商申请已审核，不能修改信息！',true);exit;
        }else{
            //添加经销商信息
    ...
    function save(){
        ...
        if($objMemProfit->save($_POST)){
            ...
            $this->end(false,app::get('b2c')->_('提交失败'));
       }
    }
    ...
    public function license(){
        ...
        $this->page('wap/member/license.html');
    }
